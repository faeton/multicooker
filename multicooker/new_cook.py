"""`multicooker new <name>` — scaffold a new cook folder from templates/."""
...
def new_cook(name: str, root: Path, participants: list[str]) -> int:
    ...
    print(f"  4. multicooker doctor {name}          # check creds/docker before cooking")
    print(f"  5. multicooker cook {name}            # launch all participants")
    return 0
