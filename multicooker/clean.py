"""`multicooker clean <task>` — tear down a cook's docker artifacts.

Removes:
  - containers belonging to compose project mc-<task>
  - networks named after the project
  - images locally built for the project (mc-<task>-{flavor})
